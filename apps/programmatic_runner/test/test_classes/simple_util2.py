...
Attribution: 
    ...
    - I adapted the function to allow map on 2 lists in racket

Note: 
    - I just used LLM to help me convert the my racket code into python 🐍
    - Who the hell would write this in python (unless you want to implement call/cc 👀)
"""
