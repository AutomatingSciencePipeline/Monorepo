...
This corresponds to outcome f) because it relates to how artifacts will be developed for the system. This is implemented in extreme programming through incremental design. Our text book states "XP teams work hard to create conditions under which the cost of changing the software doesn't rise catastrophically. The automate tests, the continual practice of improving the design, and the explicit social process all contribute to keep the cost of changes low." The team works to create conditions that the system will adhere to a strategy they have in place.

### b) Select and prioritize design principles and design characteristics

This corresponds to outcome a) because we are defining the characteristics of our system. We implement this in extreme programming through incremental design. In incremental design we are able to select and prioritize our tasks and features as we complete our coding cycles.

### c) Identify and plan for the necessary enabling systems or services needed to support design definition

This corresponds to outcome g) because it relates to the systems and services that is needed for our system. We implement this in extreme programming through continuous integration. In XP we create automated tasks to enable our systems and services.

#### d) Obtain or require access to the enabling systems or services to be used

This corresponds to outcome g) because it it relates to the systems and services that is needed for our system. We implement this in extreme programming through continuous integration as well. In XP our automated tasks are able to handle the access to our automated systems.